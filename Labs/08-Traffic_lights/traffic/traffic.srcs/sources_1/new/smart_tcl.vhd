...
architecture Behavioral of smart_tlc is
    ...
    constant c_DELAY_STOP : unsigned(5 - 1 downto 0) := b"0_0100"; -- 1 sec
                ...
                case s_state is
                    ...
                    when WEST_GO =>                                         --WEST_GO
                        ...
                        if (s_cnt < c_DELAY_GO) then
                            ...
                            if SW(1) = '1' then       -- if south sensor detects car then 
                            -- Move to the next state
                            s_state <= WEST_WAIT;
                            end if;
                            -- Reset local counter value
                    ...
                    when SOUTH_GO =>                                        --SOUTH_GO
                        ...
                        if (s_cnt < c_DELAY_GO) then
                            ...
                            if SW(0) = '1' then     -- if west sensor detects car then 
                            -- Move to the next state
                            s_state <= SOUTH_WAIT;
                            end if;
                            -- Reset local counter value
